...
| Pod 数量 | 无 Overhead (调度器认为) | 有 Overhead (调度器认为) | 实际 Host 消耗 |
|----------|------------------------|------------------------|---------------|
| 10 | 1,430 Mi | 3,930 Mi (2.75x) | ~2,000 MiB |
| 20 | 2,710 Mi | 7,710 Mi (2.84x) | ~4,100 MiB |
| 30 | 3,990 Mi | **11,490 Mi (2.88x)** | **~6,200 MiB** |
| 40 | 5,270 Mi | 15,270 Mi (2.90x) | ~8,300 MiB |
| 50 | 6,550 Mi | **19,050 Mi (2.91x)** | ~8,300 MiB |
